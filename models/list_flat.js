...
module.exports.getListByProxySpecies = (species, proxy_spe, pageNo, size, callback) => {
    GeneListFlat.find({'species': species, 'proxy_org_long': proxy_spe},{'_id':0,'event':0,'sequence':0,'proxy_org_short':0,'proxy_org_long':0}).skip(size*(pageNo-1)).limit(size).exec(callback);
}
